...
Użyj formularza [Zgłoś błąd](https://github.com/Spleenzy/BudgetYouNeedDocs/issues/new?template=bug_report_PL.yml).
...
Użyj formularza [Pytanie lub sugestia](https://github.com/Spleenzy/BudgetYouNeedDocs/issues/new?template=support_or_feedback_PL.yml).
...
dotyczące bezpieczeństwa zgłaszaj zgodnie z [SECURITY_PL.md](SECURITY_PL.md).
